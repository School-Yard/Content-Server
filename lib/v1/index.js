...
module.exports = function(app) {
  var Buckets = require('./controllers/buckets')(app),
      ...
      Properties = require('./controllers/properties')(app);
      ...
      '/:bucket_name': {
        ...
        '/items': {
          ...
          '/:item_name': {
            ...
            '/properties': {
              get: ACL(Properties.index, 0),
              put: ACL(Properties.update, 2),
              post: ACL(Properties.create, 2),

              // /v1/buckets/:bucket_name/items/:item_name/properties/:id
              '/:id': {
                get: ACL(Properties.show, 0),
                del: ACL(Properties.destroy, 2)
              }
            }
          }
        }
